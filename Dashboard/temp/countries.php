                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">إضافة دولة جديدة</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                         <form action="location/insert_country.php" method="POST" enctype="multipart/form-data">
                ...
                <?php include 'components/alerts.php' ?>
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <div class="col-md-4">
                               <a href="add_cat.php" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"
                                    ...
                                    <table id="dataTable" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 <a onclick="return confirm('Are You Sure to Delete This Countriy?');"
                                                        href="location/delete_country.php?count_id=<?php echo $row['count_id'] ?>"
                                                        >
