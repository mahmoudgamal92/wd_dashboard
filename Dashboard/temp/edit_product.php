                                 ...
                                 <div class="bgc-white p-20 bd">
                                        <div class="mT-30">
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                <input name="product_price" type="text" class="form-control" value="<?php echo 
                                             ...
                                             <div class="form-group" style="direction:rtl">
                                                 <label class="inputLabel" for="exampleInputEmail1">
                                                    *  سعر الاعلان بعد الخصم
                                                </label>
                                                <input name="discount_price" type="text" class="form-control" value="<?php echo 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="product_status">
                                                    ...
                                                    <?php
                                                    if($adv['product_status'] == 'accepted'){
                                                        echo 'selected';
                                                    }
                                                    ?>
                                                    >
                                                   ...
                                                   تحت لمراجعة
                                                    ...
                                                    <?php
                                                    if($adv['product_status'] == 'rejected'){
                                                        echo 'selected';
                                                    }
                                                    ?>
                                                    >
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                <input name="product_desc" type="text" class="form-control" value="<?php echo 
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                * صور المعرض الحالية
                                                ...
                                                <div class="col-md-2" style="margin:5px">
                                                    ...
                                                    src="./uploads/<?php echo $product['product_image']?>" style="width:100%;height:180px"/>
                                                </div>
