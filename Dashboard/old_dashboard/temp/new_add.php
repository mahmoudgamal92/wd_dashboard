...
<body class="app">
            ...
            <main class="main-content bgc-grey-100">
                <div id="mainContent">
                    <div class="container-fluid">
                        ...
                        <form action="advs/insert.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                    ...
                                    <div class="bgc-white p-20 bd">
                                        <div class="mT-30">
                                            ...
                                            value="<?php echo $user['user_token'] ?>">
                                              ...
                                              <input name="adv_type" type="hidden" value="adv">
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                required
                                                    placeholder="أدخل رابط الإعل ان">
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-control" name="state" id="state_input">
                                                    <option value="0">
                                                    أختر المدينة
                                                    </option>
                                                ...
                                                <select id="country_id" onchange="get_states()" class="form-control" name="adv_country">
                                                    <option value="0">
                                                    أختر الدولة
                                                    </option>
                                                    <?php
                                                    ...
                                                    {
                                                    ?>
                                                    <option value="<?php echo $row['count_id'] ?>">
    ...
    <script>
        function get_states() {
            var count_id = document.getElementById("country_id").value;
            const xhr = new XMLHttpRequest();
            xhr.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    if (this.responseText !== 0) {
                        document.getElementById("state_input").innerHTML = this.responseText;
                    }
                }
            };
            xhr.open("POST", "get_states.php", true);
            xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xhr.send("count_id="+count_id);
        }
    </script>
