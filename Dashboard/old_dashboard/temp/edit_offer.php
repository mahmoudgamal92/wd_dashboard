...
<?php
$id = $_GET['adv_id'];
$sql = "select * from offers where adv_id = '$id'";
$result = $con->query($sql);
$adv = $result->fetch_assoc();
?>

<?php
$user_token = $adv['user_token'];
            ...
            <main class="main-content bgc-grey-100">
                <div id="mainContent">
                    <div class="container-fluid">
                        <form action="offers/update.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="masonry-item col-md-12">
                                 <div class="bgc-white p-20 bd">
                                        <div class="mT-30">
                                            ...
                                            <input name="adv_id" type="hidden" 
                                            value="<?php echo $adv['adv_id'] ?>">
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                              ...
                                              <div class="form-group" style="direction:rtl">
                                                ...
                                                <input name="adv_arrange" type="text" class="form-control"
                                                    value="<?php echo $adv['arrange'] ?>">
                                              </div>
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                <input name="adv_url" type="text" class="form-control" value="<?php echo 
                                                $adv['url'] ?>">
                                            </div>
                                            ...
                                            <div class="form-group" style="direction:rtl">
                                                ...
                                                * صور المعرض الحالية
                                                ...
                                                <div class="row" style="margin-top:50px">
                                                    <?php
                                                    $gallery = explode(",",$adv['gallery']);    
                                                    foreach ($gallery as $src)
                                                    {
                                                    ?>
                                                <div class="col-md-2" style="margin:5px">
                                                    <img class="gallery_img" 
                                                    src="./uploads/<?php echo $src?>" style="width:100%;height:180px"/>
                                                </div>
                                                    <?php
                                                    }
                                                    ?>
